...
export interface IOTDataDumpS3ConstructProps extends cdk.StackProps {
  /**
...
const defaultProps: Partial<IOTDataDumpS3ConstructProps> = {};
 ...
 */
export class IOTDataDumpS3Construct extends Construct {
  /**
  ...
  constructor(
    parent: Construct,
    name: string,
    props: IOTDataDumpS3ConstructProps
  ) {
    super(parent, name);
